...
import { Plus, Search, Phone, Mail, MapPin, Edit2, Trash2, X, Save, Loader2, User, TrendingUp, Package, Truck } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-16 px-4">
          ...
          <p className="text-white/70 text-sm font-medium">Aucun fournisseur enregistre</p>
          <p className="text-white/40 text-xs mt-1.5 max-w-xs mx-auto">Ajoutez votre premier fournisseur pour pouvoir creer des bons de commande et suivre vos achats.</p>
          <button
            onClick={() => openForm()}
