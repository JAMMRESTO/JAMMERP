...
1. New Tables
- suppliers: Supplier directory with contact info, is_active flag
- purchase_orders: Purchase orders with status workflow (draft/ordered/partial/received/cancelled)
- purchase_order_items: Line items for purchase orders (ingredient or product)
- supplier_invoices: Invoice tracking per supplier/order
- losses: Waste/loss declarations with reasons

2. Security
- RLS enabled on all tables
- anon + authenticated access (site-scoped app pattern)
*/
